...
class ShapedTextBoxScreenshotTest {
    ...
    fun `plain fill no extras`() {
        ...
        rule.captureGolden("box_plain_fill.png") {
            Stage {
                ShapedTextBox(
                    text = "Body copy",
                    style = ShapedTextStyle(font = font, fontSize = sizePx, color = Color(0xFF263238)),
    ...
    fun `fill plus solid stroke`() {
        val (font, sizePx) = loadFont(FontPath.LATIN_REGULAR, 44f)
        rule.captureGolden("box_fill_stroke_solid.png") {
            Stage {
                ShapedTextBox(
                    text = "Outlined",
                    style = ShapedTextStyle(font = font, fontSize = sizePx, color = Color(0xFFFFC107)),
        ...
        rule.captureGolden("box_wraps_long_text.png") {
            Stage {
                ShapedTextBox(
                    ...
                    style = ShapedTextStyle(font = font, fontSize = sizePx, color = Color.White),
